...
|  --- | --- | --- | --- | --- | --- |
| `Data` | [`List<EditorialContent>`](../../doc/models/editorial-content.md) | Optional | Editorial items | List<EditorialContent> getData() | setData(List<EditorialContent> data) |
...
import com.shutterstock.api.models.EditorialImageContentDataList;
...
EditorialImageContentDataList editorialImageContentDataList = new EditorialImageContentDataList.Builder()
    .data(Arrays.asList(
