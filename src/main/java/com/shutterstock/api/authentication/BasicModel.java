...
public class BasicModel {
    ...
    /**
     * A Constructor for BasicModel.
     */
    private BasicModel(String username, String password) {
    ...
    /**
     * Builds a new {@link BasicModel.Builder} object.
     * Creates the instance with the state of the current auth model.
     * @return a new {@link BasicModel.Builder} object.
     */
    ...
    public static class Builder {
        ...
        /**
         * Builds the instance of BasicModel using the provided credentials.
         * @return The instance of BasicModel.
         */
        public BasicModel build() {
            return new BasicModel(username, password);
        }
    }
}