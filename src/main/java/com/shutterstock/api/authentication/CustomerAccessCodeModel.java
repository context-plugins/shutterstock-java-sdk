 ...
 */
public class CustomerAccessCodeModel {
    private String oauthClientId;
    private String oauthClientSecret;
    private String oauthRedirectUri;
    private OauthToken oauthToken;
    private List<OauthScopeCustomerAccessCode> oauthScopes;

    /**
     * A Constructor for CustomerAccessCodeModel.
     */
    private CustomerAccessCodeModel(String oauthClientId, String oauthClientSecret,
            String oauthRedirectUri, OauthToken oauthToken,
            List<OauthScopeCustomerAccessCode> oauthScopes) {
    ...
    /**
     * Builds a new {@link CustomerAccessCodeModel.Builder} object.
     * Creates the instance with the state of the current auth model.
     * @return a new {@link CustomerAccessCodeModel.Builder} object.
     */
    ...
    public static class Builder {
         ...
         * @return Builder The current instance of Builder.
         */
        public Builder oauthScopes(List<OauthScopeCustomerAccessCode> oauthScopes) {
            this.oauthScopes = oauthScopes;
            return this;
        }

        /**
         * Builds the instance of CustomerAccessCodeModel using the provided credentials.
         * @return The instance of CustomerAccessCodeModel.
         */
        public CustomerAccessCodeModel build() {
            return new CustomerAccessCodeModel(oauthClientId, oauthClientSecret, oauthRedirectUri,
