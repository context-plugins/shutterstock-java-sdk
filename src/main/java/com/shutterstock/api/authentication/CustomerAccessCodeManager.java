...
package com.shutterstock.api.authentication;
 ...
 */
public class CustomerAccessCodeManager extends HeaderAuth implements CustomerAccessCodeCredentials {
     ...
     */
    private CustomerAccessCodeModel authModel;

    /**
     * Constructor.
     */
    public CustomerAccessCodeManager(CustomerAccessCodeModel authModel) {
    ...
    */
    ...
    /**
     * List of OauthScopeCustomerAccessCode value for oauthScopes.
     * @return oauthScopes
     */
    public List<OauthScopeCustomerAccessCode> getOauthScopes() {
     ...
     * @param oauthScopes List of OauthScopeCustomerAccessCode value for credentials.
     * @return true if credentials matched.
     */
    public boolean equals(String oauthClientId, String oauthClientSecret, String oauthRedirectUri,
            OauthToken oauthToken, List<OauthScopeCustomerAccessCode> oauthScopes) {
    ...
    /**
     * Converts this CustomerAccessCodeManager into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CustomerAccessCodeManager [" + "oauthClientId=" + getOauthClientId()
    ...
    public CompletableFuture<OauthToken> fetchTokenAsync(final String authorizationCode,
        ...
        return oAuthApi.requestTokenCustomerAccessCodeAsync(
    ...
    public OauthToken fetchToken(String authorizationCode, Map<String, Object> additionalParameters)
        ...
        final Map<String, Object> aparams =
                additionalParameters == null ? new HashMap<String, Object>() : additionalParameters;
        OauthToken token = oAuthApi.requestTokenCustomerAccessCode(
            getBasicAuthForClient(),
            authorizationCode,
            getOauthRedirectUri(),
            aparams).getResult();
    ...
    public CompletableFuture<OauthToken> refreshTokenAsync(
        ...
        final Map<String, Object> aparams =
                additionalParameters == null ? new HashMap<String, Object>() : additionalParameters;
        return oAuthApi.refreshTokenCustomerAccessCodeAsync(
            getBasicAuthForClient(),
    ...
    public OauthToken refreshToken(final Map<String, Object> additionalParameters)
        ...
        final Map<String, Object> aparams =
                additionalParameters == null ? new HashMap<String, Object>() : additionalParameters;
        OauthToken token = oAuthApi.refreshTokenCustomerAccessCode(
            getBasicAuthForClient(),
            getOauthToken().getRefreshToken(),
            stringJoin(getOauthScopes(), " "),
            aparams).getResult();
    ...
    */
    ...
    public String getErrorMessage() {
        ...
        return "CustomerAccessCode - " + errorMessage;
    }
