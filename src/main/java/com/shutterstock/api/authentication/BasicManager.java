 ...
 */
public class BasicManager extends HeaderAuth implements BasicCredentials {

    /**
     * Private instance of the auth model containing the auth credentials.
     */
    private BasicModel authModel;

    /**
     * Constructor.
     * @param authModel The data model instance for auth credentials.
     */
    public BasicManager(BasicModel authModel) {
    ...
    /**
     * Converts this BasicManager into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "BasicManager [" + "username=" + getUsername() + ", password=" + getPassword() + "]";
    }
    /**
