...
public enum IsoCountryCode {
    ...
    private static TreeMap<String, IsoCountryCode> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static IsoCountryCode constructFromString(String toConvert) throws IOException {
        IsoCountryCode enumValue = fromString(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given string value.
     */
    public static IsoCountryCode fromString(String toConvert) {
    ...
    /**
     * Convert list of IsoCountryCode values to list of string values.
     * @param toConvert The list of IsoCountryCode values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<IsoCountryCode> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (IsoCountryCode enumValue : toConvert) {
