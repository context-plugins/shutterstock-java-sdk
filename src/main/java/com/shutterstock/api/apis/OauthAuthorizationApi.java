...
import com.shutterstock.api.exceptions.OauthProviderException;
...
public final class OauthAuthorizationApi extends BaseApi {
     ...
     */
    public ApiResponse<OauthToken> requestTokenCustomerAccessCode(
            final String authorization,
            final String code,
            final String redirectUri,
            final Map<String, Object> fieldParameters) throws ApiException, IOException {
        return prepareRequestTokenCustomerAccessCodeRequest(authorization, code, redirectUri,
     ...
     * @return    Returns the OauthToken wrapped in ApiResponse response from the API call
     */
    public CompletableFuture<ApiResponse<OauthToken>> requestTokenCustomerAccessCodeAsync(
            final String authorization,
            final String code,
            final String redirectUri,
    ...
    /**
     * Builds the ApiCall object for requestTokenCustomerAccessCode.
     */
    private ApiCall<ApiResponse<OauthToken>, ApiException> prepareRequestTokenCustomerAccessCodeRequest(
            final String authorization,
            final String code,
            final String redirectUri,
            final Map<String, Object> fieldParameters) {
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public ApiResponse<OauthToken> refreshTokenCustomerAccessCode(
            final String authorization,
            final String refreshToken,
            final String scope,
            final Map<String, Object> fieldParameters) throws ApiException, IOException {
        return prepareRefreshTokenCustomerAccessCodeRequest(authorization, refreshToken, scope,
                fieldParameters).execute();
    }
     ...
     * @return    Returns the OauthToken wrapped in ApiResponse response from the API call
     */
    public CompletableFuture<ApiResponse<OauthToken>> refreshTokenCustomerAccessCodeAsync(
            final String authorization,
            final String refreshToken,
            final String scope,
            final Map<String, Object> fieldParameters) {
    ...
    /**
     * Builds the ApiCall object for refreshTokenCustomerAccessCode.
     */
    private ApiCall<ApiResponse<OauthToken>, ApiException> prepareRefreshTokenCustomerAccessCodeRequest(
            final String authorization,
            final String refreshToken,
            final String scope,
            final Map<String, Object> fieldParameters) {
